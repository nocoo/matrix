	...
	return [
		{
			...
			timeout: 300,
			prompt:
				"Generate a morning briefing summary with weather, calendar events, and pending tasks.",
...
export function createMockRuns(): RunSummary[] {
	return [
		...
		},
		{
			...
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T09:10:00+08:00",
		},
		{
			id: "run-003",
			task: "heartbeat",
			exit_code: 1,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T09:20:00+08:00",
		},
		{
			id: "run-004",
			...
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T10:00:00+08:00",
		},
		{
			id: "run-005",
			task: "heartbeat",
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T10:10:00+08:00",
		},
		{
			id: "run-006",
			task: "heartbeat",
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T10:20:00+08:00",
		},
		{
			id: "run-007",
			task: "clock",
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T11:00:00+08:00",
		},
		{
			id: "run-008",
			task: "heartbeat",
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T11:10:00+08:00",
		},
		{
			id: "run-009",
			task: "heartbeat",
			exit_code: 1,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T11:20:00+08:00",
		},
		{
			id: "run-010",
			task: "clock",
			exit_code: 0,
			started_at: "2026-01-24T09:00:00Z",
			finished_at: "2026-01-24T12:00:00+08:00",
		},
	];
}
	...
	for (const task of tasks) {
		for (const schedule of task.schedules) {
			...
			for (let dayOffset = 0; dayOffset <= 1; dayOffset++) {
				...
				const hour =
					schedule.hour === "*"
						? runDate.getHours() + (dayOffset === 0 ? 1 : 0)
