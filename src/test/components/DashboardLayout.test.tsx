		...
		<MemoryRouter initialEntries={[initialPath]}>
			<Routes>
				<Route element={<DashboardLayout />}>
					...
					<Route
						path="/accounts"
						element={<div data-testid="accounts-outlet">Accounts Content</div>}
					/>
					<Route path="/help" element={<div data-testid="help-outlet">Help Content</div>} />
					<Route
						path="/settings"
						element={<div data-testid="settings-outlet">Settings Content</div>}
					/>
					<Route
						path="/palette"
						element={<div data-testid="palette-outlet">Palette Content</div>}
					/>
					<Route
						path="/card-showcase"
						element={<div data-testid="card-outlet">Card Content</div>}
					/>
					<Route
						path="/records"
						element={<div data-testid="records-outlet">Records Content</div>}
					/>
					<Route
						path="/progress-tracking"
						element={<div data-testid="progress-outlet">Progress Content</div>}
					/>

					<Route path="/stats" element={<div data-testid="stats-outlet">Stats Content</div>} />
					<Route
						path="/flow-comparison"
						element={<div data-testid="flow-outlet">Flow Content</div>}
					/>
					<Route
						path="/portfolio"
						element={<div data-testid="portfolio-outlet">Portfolio Content</div>}
					/>
					<Route
						path="/interactions"
						element={<div data-testid="interactions-outlet">Interactions Content</div>}
					/>
					<Route
						path="/life-ai"
						element={<div data-testid="life-ai-outlet">Life.ai Content</div>}
					/>
					<Route
						path="/component-showcase"
						element={<div data-testid="showcase-outlet">Showcase Content</div>}
					/>
				</Route>
			</Routes>
		</MemoryRouter>,
...
describe("DashboardLayout", () => {
	...
	describe("search dialog", () => {
		...
		it("shows all nav items when search query is empty", () => {
			...
			fireEvent.keyDown(document, { key: "k", metaKey: true });
			const dialog = screen
				.getByPlaceholderText("search pages...")
				.closest(".matrix-panel") as HTMLElement;
