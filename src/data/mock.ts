...
export const showcaseDialogs: ShowcaseDialog[] = [
	{
		...
		title: "About Matrix",
		description:
			"Matrix is a cyberpunk terminal dashboard built with React, TypeScript, and Tailwind CSS.",
		style: "info",
	},
	{
		id: "d2",
...
export const lifeAiStats: LifeAiStat[] = [
	...
	},
	{
		title: "Sleep",
		value: "7h 24m",
		subtitle: "Deep: 2h 10m",
		trend: { value: -3.2, label: "vs avg" },
	},
	{
		title: "Heart Rate",
		value: "72 bpm",
	...
	},
	{
		...
		trend: { value: 8.1, label: "vs target" },
	},
];
