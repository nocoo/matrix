		...
		<div className="space-y-4">
			<AsciiBox title="PILLS" subtitle="chip styles">
				<p className="text-xs font-mono text-matrix-muted">
					Pill chips in every style: solid, soft, outline, icon, size scale, gradient, dot
					indicators, and closable.
				</p>
			</AsciiBox>
					...
					<div className="flex flex-wrap gap-2">
						{[
							...
							<span
								key={pill.label}
								className={cn(
									"flex items-center gap-1.5 px-3 py-1 text-[10px] font-mono font-bold uppercase",
									pill.cls,
								)}
							>
								<span>{pill.icon}</span>
						...
						{[
							{
								...
								cls: "text-green-400 border-green-500/30",
							},
							{
								label: "PAUSED",
								dotColor: "bg-yellow-400",
								cls: "text-yellow-400 border-yellow-500/30",
							},
							...
							<span
								key={pill.label}
								className={cn(
									"flex items-center gap-1.5 px-3 py-1 text-[10px] font-mono font-bold uppercase border",
									pill.cls,
								)}
							>
