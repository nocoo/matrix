		...
		<div className="space-y-4">
			<AsciiBox title="BUTTONS" subtitle="action triggers">
				<p className="text-xs font-mono text-matrix-muted">
					Matrix-styled buttons and action triggers. Every variant, size, state, and composition
					pattern.
				</p>
			</AsciiBox>
			...
			<Section title="VARIANTS">
				<div className="flex flex-wrap gap-3">
					...
					<MatrixButton className="!bg-transparent !border-matrix-ghost !text-matrix-muted hover:!bg-matrix-panel hover:!text-matrix-primary">
						OUTLINE
					</MatrixButton>
					<MatrixButton className="!bg-transparent !border-transparent !text-matrix-muted hover:!bg-matrix-primary/5 hover:!text-matrix-primary">
						GHOST
					</MatrixButton>
					<MatrixButton className="!bg-transparent !border-transparent !text-matrix-primary underline underline-offset-4 hover:!text-matrix-bright">
						LINK
					</MatrixButton>
				</div>
			</Section>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
				<Section title="DISABLED">
					<div className="flex flex-wrap gap-3">
						...
						<MatrixButton primary disabled>
							PRIMARY
						</MatrixButton>
						<MatrixButton disabled className="!bg-red-500/10 !border-red-500/30 !text-red-400">
							DESTRUCTIVE
						</MatrixButton>
						<MatrixButton
							disabled
							className="!bg-transparent !border-matrix-ghost !text-matrix-muted"
						>
							OUTLINE
						</MatrixButton>
					</div>
			...
			<Section title="BUTTON GROUPS">
				<div className="space-y-4">
					{/* Pair */}
					<div>
						<p className="text-[10px] font-mono text-matrix-dim uppercase mb-2">
							Primary + Secondary
						</p>
					...
					<div>
						...
						<div className="inline-flex">
							<MatrixButton primary>SAVE</MatrixButton>
							<MatrixButton primary className="!border-l-0 !px-2 !min-w-0">
								▼
							</MatrixButton>
						</div>
					</div>
