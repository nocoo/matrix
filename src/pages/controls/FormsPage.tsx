		...
		<div className="space-y-4">
			<AsciiBox title="FORMS" subtitle="layouts">
				<p className="text-xs font-mono text-matrix-muted">
					Form layouts that integrate Matrix styling: profile forms, security settings, newsletter
					subscriptions, file uploads, and success states.
				</p>
			</AsciiBox>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
				<Section title="PROFILE FORM">
					<form onSubmit={(e) => e.preventDefault()} className="space-y-3">
						...
						<MatrixButton primary className="mt-2">
							SAVE PROFILE
						</MatrixButton>
					</form>
				</Section>
				...
				<Section title="SECURITY">
					<form onSubmit={(e) => e.preventDefault()} className="space-y-3">
						...
						<div className="flex items-center justify-between py-2">
							<div>
								<span className="text-xs font-mono text-matrix-muted uppercase font-bold block">
									Two-factor auth
								</span>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
				...
				<Section title="FILE UPLOAD">
					<div className="border-2 border-dashed border-matrix-ghost p-6 text-center hover:border-matrix-dim transition-colors cursor-pointer">
						...
						<p className="text-[10px] font-mono text-matrix-dim mt-1">PNG, JPG, SVG up to 4MB</p>
						<MatrixButton size="small" className="mt-3">
							BROWSE FILES
						</MatrixButton>
					</div>
				</Section>
