			...
			<div className="max-w-2xl mx-auto space-y-6">
				<AsciiBox title={t("pages.static.termsOfService")}>
					<div className="space-y-4 font-mono text-xs text-matrix-muted leading-relaxed">
						<p>
							<DecodingText text="> last updated: 2026-02-13" className="text-matrix-dim" />
						</p>
						<p>
							By accessing and using the Matrix Dashboard System, you agree to be bound by these
							terms and conditions. The system is provided &quot;as is&quot; without warranty of any
							kind.
						</p>
						<p>
						...
						<p className="text-matrix-dim">{t("pages.static.endOfDocument")}</p>
					</div>
				</AsciiBox>
